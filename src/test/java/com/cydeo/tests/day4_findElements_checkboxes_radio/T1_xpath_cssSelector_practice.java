...
public class T1_xpath_cssSelector_practice {
    ...
    public static void main(String[] args) {
        ...
        //Locate homeLink using cssSelector with syntax #2
        ...
        //Locate header using cssSelector: locate parent element and move down to h2(syntax #2)
        WebElement header_ex1 = driver.findElement(By.cssSelector("div.example>h2"));

        //Locate header using xpath:, and using web elements text "Forgot Password"

        //WebElement header_ex2= driver.findElement(By.xpath("//h2[.='Forgot Password']"));//The same with the belove. We are using . instead of text()
